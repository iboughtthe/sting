...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@stringsessionAK47bot](tg://openmessage?user_id=1472531255) \nA Bot By @stringsessionAK47")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/stringsessionAK47'),
                InlineKeyboardButton('Developer', url='https://t.me/stringsessionAK47')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/stringsessionAK47'),
            ]
        ]
    )
